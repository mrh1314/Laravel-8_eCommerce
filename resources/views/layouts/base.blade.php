...
<body>
    ...
    <div class="log_in">
                            ...
                            @if (Auth::user()->utype === 'ADM')
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                        ...
                                        <li><a class="dropdown-item" href="{{ route('admin.category') }}">Categories</a>
                                        </li>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('product.cart') }}">Cart <i
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm">
                        ...
                        <div>
                            <a class="footer_link" href=""><i class="fas fa-globe-americas"></i><span
                                    class="footer_con">Dhaka,Bangladesh</span></a>
                            <a class="footer_link" href=""><i class="fas fa-phone-alt"></i><span
                                    class="footer_con">+088-156*2156</span></a>
                            <a class="footer_link" href=""><i class="fas fa-envelope"></i><span
                                    class="footer_con">Test@test.com</span></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div>
            <p class="last_content">Template made by &copy; Rakib Hasan</p>
        </div>
